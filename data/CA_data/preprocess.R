...
cal_wide = read.csv("data/CA_data/Cal_county_temp_1895_2024_Wide.csv") 
YEAR_BEGIN <- 2011 
YEAR_END <- 2024 
...
#write.csv(temp_standardized, "data/CA_data/CA_time_series.csv",row.names = F)
...
#write.csv(temp_standardized, "data/CA_data/CA_time_series_1895_2024.csv",row.names = F)
