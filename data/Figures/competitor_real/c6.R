...
dir.create( paste0("result/c6_",scenario,"_n",num_node), showWarnings = FALSE)

write.csv(output_label, 
          paste0("result/c6_",scenario,"_n",num_node,"/output_label.csv"),
          row.names = F)
...
CA_label <- NAC(CA_adj, CA_data, K=true_K)
...
word_label <- NAC(word_adj, as.matrix(word_zscore), K=true_K)
